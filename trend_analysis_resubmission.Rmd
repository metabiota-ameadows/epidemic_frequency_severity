...
# Subset data to analysis period of interest
## excluding events starting after 2019 to avoid inclusion of ongoing events (including Covid-19)
event_table <- event_table[Event_start_year < 2020 & Event_start_year >= 1960,]
...
Map showing the total number of  spillover events (color scale) caused by the selected pathogens by country. Countries with no fill have no documented spillover of the included pathogens.
...
* Analyzing trend in annual spillover events and deaths from 1960 through 2019 (training data excludes ongoing events such as Covid-19).
